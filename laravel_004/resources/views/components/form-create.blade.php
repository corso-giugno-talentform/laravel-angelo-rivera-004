        ...
        <form class="" action="{{ route('films.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                @foreach ($genres as $genre)
                    <div>
                        <input name="genres[]" class="custom-checkbox" type="checkbox" value="{{ $genre->id }}"
            ...
            <div class="mb-3">
                <label for="cover" class="custom-file-label"> <img
                        src="https://img.icons8.com/?size=100&id=0w8efhRZ2Ijj&format=png&color=000000" width="30"
                        height="30" alt="Add genre" /> Immagine Cover</label>
